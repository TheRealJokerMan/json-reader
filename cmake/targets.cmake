...
function(com_executable targetName)
    ...
    set_target_properties(${targetName}
        PROPERTIES
            ...
            MACOSX_BUNDLE_COPYRIGHT             "2024 Jamie Kenyon. SPDX-License-Identifier: MIT."
...
# Create a new named CMake target. Use this function to create a test.
function(com_test targetName)
    set(multiValueKeywords
        SOURCES                     # List of source files.
        LIBRARIES                   # List of dependent libraries to link that upstream consumers don't require.
        PROPERTIES                  # List of test properties.
    )
    ...
    # Define the target.
    add_executable(${targetName} ${args_SOURCES})
    _set_target_defaults(${targetName})
    ...
    # Create the test.
    add_test(NAME test-${targetName} COMMAND $<TARGET_FILE:${targetName}>)

    # Add any properties.
    if(args_PROPERTIES)
        set_tests_properties(test-${targetName}
            PROPERTIES
                ${args_PROPERTIES}
        )
    endif()
